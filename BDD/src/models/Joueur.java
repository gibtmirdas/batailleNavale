...
public class Joueur {
    ...
    public Joueur(String pseudo, String password, ArrayList<Integer> cardsId,
        ...
        assert !pseudo.equals("") && !password.equals("");
        this.id = id;
        this.pseudo = pseudo;
    ...
    public Joueur(DBObject o) {
        assert o != null;
        id = (int) o.get(TJoueurs.ID_FIELD);
        pseudo = (String) o.get(TJoueurs.NAME_FIELD);
        password = (String) o.get(TJoueurs.PASSWORD_FIELD);
        cardsId = (ArrayList<Integer>) o.get(TJoueurs.CARDS_FIELD);
        score = (int) o.get(TJoueurs.SCORE_FIELD);
        credit = (int) o.get(TJoueurs.CREDIT_FIELD);
    }
    ...
    public static boolean canLogin(String username, String password) {
        assert !username.equals("") && !password.equals("");
